...
export default function Onherservice() {
  ...
  const [mobile, setmobile] = useState("")
   const [myOnherservice, setMyOnherservice]=useState({id:id, name:name, email:email, mobile:mobile})
...
let nuwOnherservic = {
  ...
  function handleClickMyOnhersrvice(e){
    e.preventDefault();
   console.log("in fun")
   console.log(Onherservice)
    axios({
    method:'post',
    //url:'api/ticket/add',
    ...
    return (
        ...
        <input type="submit" value="submit" onClick={handleClickMyOnhersrvice}/>
